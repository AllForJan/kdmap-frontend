...
Vue.component('sidebar', __webpack_require__(36));
Vue.component('results', __webpack_require__(39));
Vue.component('item', __webpack_require__(42));
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    showResultsOnMap: function showResultsOnMap() {
      Object.entries(this.results).forEach(function (_ref) {
  ...
  watch: {
    results: function results(newVal, oldVal) {
...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _vm._v(" "),
      _vm.resultsEmpty
        ? _c("div", [_c("p", [_vm._v("Neboli nájdené žiadne výsledky")])])
        : _vm._e()
    ],
    2
  )
    ...
    [
      ...
      _c(
        "div",
        {
          ...
          staticClass: "row item-detail pl-3"
        },
        [
          _c("div", { staticClass: "col-12" }, [
